...
<div class="app">
  ...
  <tbody>
	<?php foreach($uti as $utt): ?>
		<tr>
      <th scope="row"><?php echo $utt['title'];?></th>
	  <th scope="row"><?php echo $utt['author'];?></th>     
	  <th scope="row"><?php echo $utt['genre'];?></th>
	  <th scope="row"><?php echo $utt['publicatin_year'];?></th>
      <th scope="row"><?php echo $utt['total_copies'];?></th>
	  <th scope="row"><?php echo $utt['available_copies'];?></th>
	  <th scope="row"><?php echo $utt['description'];?></th>
